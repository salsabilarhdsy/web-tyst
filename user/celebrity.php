        ...
        <div class="container">
            <div class="content">
                ...
                if(!isset($_GET['id'])){
                    ...
                    <?php     
                    $result = mysqli_query($koneksi,"SELECT * FROM article WHERE id_category=3 ORDER BY date DESC");
                    while($article = mysqli_fetch_array($result)) {
                        ...
                        <div class="row" id="<?= $article['id'] ?>">
                            <div class="col pb-3">
                                ...
                                <a href="celebrity.php?id=<?= $article['id'] ?>">Read More</a>
                            </div>
                        </div>

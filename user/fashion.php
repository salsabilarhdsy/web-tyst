            ...
            <div class="content">
                ...
                if(!isset($_GET['id'])){
                   ...
                   <div class="row pt-3 justify-content-center">
                    ...
                    <?php     
                    $result = mysqli_query($koneksi,"SELECT * FROM article WHERE id_category=1 ORDER BY date DESC");
                    while($article = mysqli_fetch_array($result)) {
                        ...
                        <div class="row" id="<?= $article['id'] ?>">
                            <div class="col pb-3">
                                ...
                                <p>
                                    <?=substr($new,0,250);?>...
                                    <a href="beauty.php?id=<?= $article['id'] ?>">Read More</a>
                                </p>
                            </div>
                        </div>
